...
class PrivateCatalogGrpcAsyncIOTransport(PrivateCatalogTransport):
    """gRPC AsyncIO backend transport for PrivateCatalog.
    ...
    def search_catalogs(self) -> Callable[
        ...
        Returns:
            Callable[[~.SearchCatalogsRequest],
                    Awaitable[~.SearchCatalogsResponse]]:
    ...
    def search_products(self) -> Callable[
        ...
        Returns:
            Callable[[~.SearchProductsRequest],
                    Awaitable[~.SearchProductsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def search_versions(self) -> Callable[
        ...
        Returns:
            Callable[[~.SearchVersionsRequest],
                    Awaitable[~.SearchVersionsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
